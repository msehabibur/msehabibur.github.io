...
export const STRUCTURES = [
  {
    ...
    sg: "Fd-3m (#227)", a: 5.431, supercell: [2, 2, 2], color: "#b4cfd5",
  ...
  },
  {
    ...
    sg: "F-43m (#216)", a: 5.653, supercell: [2, 2, 2], color: "#b8d2d7",
  ...
  },
  {
    ...
    sg: "Fm-3m (#225)", a: 4.212, supercell: [2, 2, 2], color: "#b5d0d5",
  ...
  },
  {
    ...
    sg: "Pm-3m (#221)", a: 3.905, supercell: [3, 3, 3], color: "#9cc0c7",
