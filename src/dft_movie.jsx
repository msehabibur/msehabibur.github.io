...
export default function DFTMovieModule() {
  ...
  const renderScene = () => {
    ...
    case "many_body": {
      ...
      const lines = [
        { text: "Full Many-Body Hamiltonian:",     color: P.blue,   delay: 0.04 },
        { text: "Ĥ = T̂ₑ + V̂ₑₑ + V̂ₑN + T̂N",      color: P.ink,    delay: 0.10 },
        { text: "",                                color: P.muted,  delay: 0.14 },
        { text: "T̂ₑ = -ħ²/2mₑ Σᵢ ∇ᵢ²",           color: P.green,  delay: 0.18 },
        { text: "  (electron kinetic energy)",      color: P.muted,  delay: 0.22 },
        { text: "",                                color: P.muted,  delay: 0.25 },
        { text: "V̂ₑₑ = Σᵢ<ⱼ e²/|rᵢ-rⱼ|",          color: P.warn,   delay: 0.28 },
        { text: "  (e⁻-e⁻ repulsion — HARD!)",     color: P.warn,   delay: 0.32 },
        { text: "",                                color: P.muted,  delay: 0.35 },
        { text: "V̂ₑN = -Σᵢ,I ZI e²/|rᵢ-RI|",      color: P.amber,  delay: 0.38 },
        { text: "  (e⁻-nucleus attraction)",        color: P.muted,  delay: 0.42 },
        { text: "",                                color: P.muted,  delay: 0.45 },
        { text: "T̂N = -Σ_I ħ²/2MI ∇_I²",           color: P.purple, delay: 0.48 },
        { text: "  (nuclear kinetic energy)",       color: P.muted,  delay: 0.52 },
        { text: "",                                color: P.muted,  delay: 0.55 },
        { text: "Ĥ Ψ(r₁..rN,R₁..RM) = E Ψ",       color: P.ink,    delay: 0.58 },
        { text: "",                                color: P.muted,  delay: 0.62 },
        { text: "3N coords → exponential wall",    color: P.red,    delay: 0.65 },
        { text: "N=10 → Ψ needs ~10³⁰ numbers!",  color: P.red,    delay: 0.70 },
      ];
    ...
    case "born_opp": {
      ...
      const eqLines = [
        { text: "Born-Oppenheimer Approx.",      color: P.blue,   delay: 0.04 },
        { text: "",                              color: P.muted,  delay: 0.08 },
        { text: "Mass ratio:",                   color: P.muted,  delay: 0.11 },
        { text: "M_proton / m_e ≈ 1836",         color: P.amber,  delay: 0.15 },
        { text: "→ nuclei ~1836× slower",        color: P.green,  delay: 0.19 },
        { text: "",                              color: P.muted,  delay: 0.22 },
        { text: "Decouple wavefunction:",        color: P.blue,   delay: 0.25 },
        { text: "Ψ_tot(r,R) ≈ ψ_el(r;R)·χ(R)", color: P.ink,    delay: 0.29 },
        { text: "",                              color: P.muted,  delay: 0.33 },
        { text: "Fix nuclei → solve electrons:", color: P.blue,   delay: 0.36 },
        { text: "Ĥ_el ψ_el = E_el ψ_el",        color: P.ink,    delay: 0.40 },
        { text: "",                              color: P.muted,  delay: 0.44 },
        { text: "Ĥ_el = T̂ₑ + V̂ₑₑ + V̂ₑN(R)",    color: P.purple, delay: 0.47 },
        { text: "  R enters as parameter",       color: P.muted,  delay: 0.51 },
        { text: "",                              color: P.muted,  delay: 0.54 },
        { text: "External potential:",           color: P.teal,   delay: 0.57 },
        { text: "v_ext(r) = -Σ_I ZI/|r-RI|",   color: P.teal,   delay: 0.61 },
        { text: "",                              color: P.muted,  delay: 0.65 },
        { text: "→ Potential Energy Surface",    color: P.green,  delay: 0.68 },
        { text: "E_el(R) = PES for nuclei",      color: P.muted,  delay: 0.72 },
      ];
    ...
    case "hohenberg_kohn": {
      ...
      const eqLines = [
        { text: "Hohenberg-Kohn Theorems (1964)", color: P.amber,  delay: 0.04 },
        { text: "",                               color: P.muted,  delay: 0.08 },
        { text: "HK Theorem 1:",                  color: P.blue,   delay: 0.11 },
        { text: "n(r) → v_ext(r)",                color: P.ink,    delay: 0.15 },
        { text: "1-to-1 mapping (unique)",         color: P.muted,  delay: 0.19 },
        { text: "proof: reductio ad absurdum",     color: P.muted,  delay: 0.23 },
        { text: "",                               color: P.muted,  delay: 0.27 },
        { text: "HK Theorem 2:",                  color: P.purple, delay: 0.30 },
        { text: "E[n] ≥ E[n₀]  ∀ n ≠ n₀",        color: P.ink,    delay: 0.34 },
        { text: "variational principle for E[n]", color: P.muted,  delay: 0.38 },
        { text: "",                               color: P.muted,  delay: 0.42 },
        { text: "Key insight:",                   color: P.green,  delay: 0.45 },
        { text: "n(r) is a 3D function!",         color: P.green,  delay: 0.49 },
        { text: "Ψ needs 3N dimensions",          color: P.muted,  delay: 0.53 },
        { text: "",                               color: P.muted,  delay: 0.57 },
        { text: "n(r) = N∫|Ψ|²dr₂...drN",        color: P.teal,   delay: 0.60 },
        { text: "  (integrate out N-1 electrons)",color: P.muted,  delay: 0.64 },
        { text: "",                               color: P.muted,  delay: 0.68 },
        { text: "Dimensionality reduction:",      color: P.pink,   delay: 0.71 },
        { text: "3N=300 → just 3 dimensions!",    color: P.pink,   delay: 0.75 },
      ];
    ...
    case "kohn_sham": {
      ...
      const eqLines = [
        { text: "Kohn-Sham Scheme (1965)",        color: P.purple, delay: 0.04 },
        { text: "",                               color: P.muted,  delay: 0.08 },
        { text: "Trick: fictitious non-inter.",   color: P.blue,   delay: 0.11 },
        { text: "electrons with same n(r)",       color: P.muted,  delay: 0.15 },
        { text: "",                               color: P.muted,  delay: 0.18 },
        { text: "KS equations (per orbital φᵢ):", color: P.blue,   delay: 0.21 },
        { text: "[-½∇²+v_KS(r)]φᵢ = εᵢ φᵢ",     color: P.ink,    delay: 0.25 },
        { text: "",                               color: P.muted,  delay: 0.29 },
        { text: "v_KS = v_ext + v_H + v_xc",     color: P.purple, delay: 0.32 },
        { text: "",                               color: P.muted,  delay: 0.36 },
        { text: "v_H(r) = ∫n(r')/|r-r'|dr'",     color: P.blue,   delay: 0.39 },
        { text: "  (Hartree/Coulomb potential)",  color: P.muted,  delay: 0.43 },
        { text: "",                               color: P.muted,  delay: 0.46 },
        { text: "v_xc(r) = δE_xc[n]/δn(r)",      color: P.pink,   delay: 0.49 },
        { text: "  (XC potential — unknown!)",    color: P.warn,   delay: 0.53 },
        { text: "",                               color: P.muted,  delay: 0.56 },
        { text: "n(r) = Σᵢ fᵢ |φᵢ(r)|²",         color: P.green,  delay: 0.59 },
        { text: "  (density from orbitals)",      color: P.muted,  delay: 0.63 },
        { text: "",                               color: P.muted,  delay: 0.66 },
        { text: "→ Self-consistent solution!",    color: P.ok,     delay: 0.69 },
      ];
    ...
    case "xc_functional": {
      ...
      const eqLines = [
        { text: "XC Functional E_xc[n]",          color: P.pink,   delay: 0.04 },
        { text: "exchange + correlation",           color: P.muted,  delay: 0.08 },
        { text: "UNKNOWN EXACTLY",                  color: P.warn,   delay: 0.12 },
        { text: "",                                color: P.muted,  delay: 0.15 },
        { text: "LDA (1980):",                      color: P.blue,   delay: 0.18 },
        { text: "ε_xc^LDA = ∫n(r)ε_xc^hom dr",    color: P.ink,    delay: 0.22 },
        { text: "local density only",               color: P.muted,  delay: 0.26 },
        { text: "",                                color: P.muted,  delay: 0.29 },
        { text: "GGA-PBE (1996):",                  color: P.green,  delay: 0.32 },
        { text: "adds gradient ∇n(r)",              color: P.muted,  delay: 0.36 },
        { text: "better for molecules",             color: P.muted,  delay: 0.40 },
        { text: "",                                color: P.muted,  delay: 0.43 },
        { text: "meta-GGA SCAN:",                   color: P.teal,   delay: 0.46 },
        { text: "adds ∇²n and τ (KE density)",      color: P.muted,  delay: 0.50 },
        { text: "",                                color: P.muted,  delay: 0.53 },
        { text: "Hybrid HSE06:",                    color: P.purple, delay: 0.56 },
        { text: "0.25·E_x^HF + 0.75·E_x^PBE",     color: P.ink,    delay: 0.60 },
        { text: "+ E_x^PBE,LR + E_c^PBE",          color: P.ink,    delay: 0.64 },
        { text: "25% exact HF exchange",            color: P.muted,  delay: 0.68 },
        { text: "",                                color: P.muted,  delay: 0.71 },
        { text: "RPA: full non-local corr.",        color: P.pink,   delay: 0.74 },
      ];
    ...
    case "scf_cycle": {
      ...
      const steps = [
        { text: "SCF for Na atom (Z=11):",        color: P.amber,  delay: 0.04 },
        { text: "",                               color: P.muted,  delay: 0.07 },
        { text: "Step 1: Initial guess",          color: P.blue,   delay: 0.10 },
        { text: "n⁰(r) = atomic densities",       color: P.muted,  delay: 0.14 },
        { text: "",                               color: P.muted,  delay: 0.17 },
        { text: "Step 2: Build v_KS",             color: P.purple, delay: 0.20 },
        { text: "v_KS=-1/r+v_H[n]+v_xc[n]",      color: P.ink,    delay: 0.24 },
        { text: "",                               color: P.muted,  delay: 0.27 },
        { text: "Step 3: Solve KS equations",     color: P.amber,  delay: 0.30 },
        { text: "→ orbitals 1s,2s,2p,3s",         color: P.muted,  delay: 0.34 },
        { text: "",                               color: P.muted,  delay: 0.37 },
        { text: "Step 4: New density",            color: P.green,  delay: 0.40 },
        { text: "n=2|φ_1s|²+2|φ_2s|²",           color: P.ink,    delay: 0.44 },
        { text: " +6|φ_2p|²+1|φ_3s|²",           color: P.ink,    delay: 0.48 },
        { text: "",                               color: P.muted,  delay: 0.51 },
        { text: "Step 5: Check convergence",      color: P.ok,     delay: 0.54 },
        { text: "|n_new-n_old| < 1e-6",           color: P.muted,  delay: 0.58 },
        { text: "",                               color: P.muted,  delay: 0.61 },
        { text: "Iteration history (eV):",        color: P.teal,   delay: 0.64 },
        { text: "E1=-161.2  E2=-161.7",           color: P.ink,    delay: 0.68 },
        { text: "E3=-161.84 E4=-161.85 conv!",    color: P.ok,     delay: 0.72 },
      ];
    ...
    case "output": {
      ...
      const eqLines = [
        { text: "What DFT Delivers:",              color: P.ok,     delay: 0.04 },
        { text: "",                               color: P.muted,  delay: 0.07 },
        { text: "① E_tot → ΔE_form, adsorption",  color: P.blue,   delay: 0.10 },
        { text: "",                               color: P.muted,  delay: 0.14 },
        { text: "② Forces Fᵢ = -∂E/∂Rᵢ",          color: P.green,  delay: 0.17 },
        { text: "   → relaxation, phonons",        color: P.muted,  delay: 0.21 },
        { text: "",                               color: P.muted,  delay: 0.24 },
        { text: "③ Band struct. εₙ(k)",            color: P.purple, delay: 0.27 },
        { text: "   → bandgap Eg, eff. mass m*",   color: P.muted,  delay: 0.31 },
        { text: "",                               color: P.muted,  delay: 0.34 },
        { text: "④ DOS: g(ε)=Σₙ δ(ε-εₙ(k))",      color: P.amber,  delay: 0.37 },
        { text: "   → orbital character, PDOS",    color: P.muted,  delay: 0.41 },
        { text: "",                               color: P.muted,  delay: 0.44 },
        { text: "⑤ Charge density n(r)",           color: P.teal,   delay: 0.47 },
        { text: "   → bonding, Bader charges",     color: P.muted,  delay: 0.51 },
        { text: "",                               color: P.muted,  delay: 0.54 },
        { text: "ZnTe Bandgap:",                  color: P.teal,   delay: 0.57 },
        { text: "GGA-PBE:  Eg = 2.26 eV",         color: P.green,  delay: 0.61 },
        { text: "HSE06:    Eg = 2.50 eV",         color: P.purple, delay: 0.65 },
        { text: "Exp:      Eg = 2.30 eV",         color: P.ok,     delay: 0.69 },
      ];
