...
function CommonMistakes({ mistakes, color }) {
  return (
    <div style={{ marginTop: 10, background: "#f2f5f6", border: "1.5px solid #347d8b33", borderRadius: 10, padding: "12px 16px" }}>
      <div style={{ fontSize: 12, fontWeight: 500, color: "#347d8b", marginBottom: 6 }}>Common Mistakes — Watch Out!</div>
      <div style={{ fontSize: 13, lineHeight: 2.0, color: T.ink }}>
        {mistakes.map((m, i) => (
...
function MatSciExample({ text, color }) {
  return (
    <div style={{ marginTop: 10, background: "#f2f6f7", border: "1.5px solid #398a9a33", borderRadius: 10, padding: "12px 16px" }}>
      <div style={{ fontSize: 12, fontWeight: 500, color: "#398a9a", marginBottom: 4 }}>Materials Science Example</div>
...
const ML_BLOCKS = [
  ...
  { id: "generative", label: "Generative & Advanced", color: "#3a8c9c" },
...
function WhatIsMLSection() {
  ...
  return (
    <Card color={C} title="What Is Machine Learning?" formula="f(features) → prediction">
      <div style={{ background: "#fafbfb", border: "1.5px solid #98bec533", borderRadius: 10, padding: "12px 16px", marginBottom: 14 }}>
        <div style={{ fontSize: 13, fontWeight: 500, color: "#317583", marginBottom: 4 }}>Simple Analogy</div>
        <div style={{ fontSize: 13, lineHeight: 2.0, color: T.ink }}>
      ...
      <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
        <div style={{ flex: "0 0 510px" }}>
          <svg width={500} height={240} style={{ display: "block", background: T.surface, borderRadius: 8, border: `1px solid ${T.border}` }}>
            ...
            {/* Legend */}
            <circle cx={380} cy={30} r={5} fill="#398a9a33" stroke="#398a9a" strokeWidth={1} />
            <text x={392} y={34} fontSize={12} fill={T.muted}>Semiconductor</text>
            <circle cx={380} cy={50} r={5} fill="#4b98a733" stroke="#4b98a7" strokeWidth={1} />
        ...
        <div style={{ flex: 1, minWidth: 200 }}>
          <div style={{ marginTop: 0, background: T.surface, borderRadius: 8, padding: 12, border: `1px solid ${T.border}` }}>
            ...
            <CalcRow eq="Class 0 (Semiconductor) count" result="3" color="#398a9a" />
            <CalcRow eq="Class 1 (Metal) count" result="3" color="#4b98a7" />
          ...
          <div style={{ marginTop: 10, background: T.surface, borderRadius: 8, padding: 12, border: `1px solid ${T.border}` }}>
            ...
            <CalcRow eq="Mean Radius (Metals)" result={((1.24 + 1.28 + 1.43) / 3).toFixed(2) + " Å"} color="#4b98a7" />
          ...
          <svg width={svgW} height={svgH} style={{ display: "block", background: T.surface, borderRadius: 8, border: `1px solid ${T.border}` }}>
            ...
            {predictions.map((p, i) => (
              <line key={i} x1={sx(p.x)} y1={sy(p.y)} x2={sx(p.x)} y2={sy(p.yhat)}
                stroke="#347d8b88" strokeWidth={1} strokeDasharray="2,2" />
            ))}
            {/* Data points */}
            {data.map((d, i) => (
              <g key={i}>
          ...
          <div style={{ marginTop: 4, background: T.surface, borderRadius: 8, padding: 12, border: `1px solid ${T.border}` }}>
            ...
            {predictions.map((p, i) => (
              <CalcRow key={i} eq={`error${i + 1} = ${p.y.toFixed(2)} − ${p.yhat.toFixed(2)}`}
                result={errors[i].toFixed(2)} color="#347d8b" />
            ))}
            <div style={{ height: 6 }} />
      ...
      <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
        <div style={{ flex: "0 0 510px" }}>
          <svg width={svgW} height={svgH} style={{ display: "block", background: T.surface, borderRadius: 8, border: `1px solid ${T.border}` }}>
            ...
            {/* Test points */}
            {testPts.map((p, i) => (
              <circle key={`te${i}`} cx={sx(p.x)} cy={sy(p.y)} r={5} fill="#347d8b44" stroke="#347d8b" strokeWidth={1.5} />
            ))}
            <circle cx={250} cy={svgH - 19} r={4} fill={C + "44"} stroke={C} />
            <text x={258} y={svgH - 12} fontSize={11} fill={T.muted}>Train</text>
            <circle cx={290} cy={svgH - 19} r={4} fill="#347d8b44" stroke="#347d8b" />
        ...
        <div style={{ flex: 1, minWidth: 200 }}>
          ...
          <div style={{ marginTop: 4, background: T.surface, borderRadius: 8, padding: 12, border: `1px solid ${T.border}` }}>
            ...
            <CalcRow eq="Test data points" result="4" color="#347d8b" />
            ...
            <CalcRow eq={`Test RMSE`} result={testRMSE.toFixed(3)} color="#347d8b" />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginTop: 10 }}>
            ...
            <ResultBox label="Test RMSE" value={testRMSE.toFixed(3)} color="#347d8b" sub="lower is better" />
          </div>
...
function CrossValidationSection() {
  ...
  const foldColors = ["#398a9a", "#50a1b1", "#347d8b", "#378695", "#56a3b3"];
  const svgW = 500, svgH = 240;
      ...
      <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
          ...
          <svg width={svgW} height={svgH} style={{ display: "block", background: T.surface, borderRadius: 8, border: `1px solid ${T.border}` }}>
            ...
            {leftPts.length > 0 && (
              <line x1={40} y1={sy(leftPred)} x2={sx(splitThreshold)} y2={sy(leftPred)}
                stroke="#50a1b1" strokeWidth={2} strokeDasharray="6,3" />
            )}
            {rightPts.length > 0 && (
              <line x1={sx(splitThreshold)} y1={sy(rightPred)} x2={svgW - 10} y2={sy(rightPred)}
                stroke="#347d8b" strokeWidth={2} strokeDasharray="6,3" />
            )}
            {/* Data points */}
            {materials.map((m, i) => (
              <g key={i}>
                <circle cx={sx(m.en)} cy={sy(m.bg)} r={6}
                  fill={m.en <= splitThreshold ? "#50a1b133" : "#347d8b33"}
                  stroke={m.en <= splitThreshold ? "#50a1b1" : "#347d8b"} strokeWidth={1.5} />
        ...
        <div style={{ flex: 1, minWidth: 200 }}>
          ...
          <div style={{ marginTop: 4, background: T.surface, borderRadius: 8, padding: 12, border: `1px solid ${T.border}` }}>
            ...
            <CalcRow eq={`Left (≤ ${splitThreshold.toFixed(2)}): ${leftPts.length} materials`} result={`ȳ = ${leftPred.toFixed(3)} eV`} color="#50a1b1" />
            <CalcRow eq={`Left MSE = (1/${leftPts.length})Σ(yᵢ − ${leftPred.toFixed(2)})²`} result={mseLeft.toFixed(4)} color="#50a1b1" />
            <CalcRow eq={`Right (> ${splitThreshold.toFixed(2)}): ${rightPts.length} materials`} result={`ȳ = ${rightPred.toFixed(3)} eV`} color="#347d8b" />
            <CalcRow eq={`Right MSE = (1/${rightPts.length})Σ(yᵢ − ${rightPred.toFixed(2)})²`} result={mseRight.toFixed(4)} color="#347d8b" />
...
function RandomForestSection() {
  ...
  const svgW = 500, svgH = 240;
  const treeColors = ["#398a9a", "#50a1b1", "#56a3b3"];
        ...
        <div style={{ flex: "0 0 510px" }}>
          <svg width={svgW} height={svgH} style={{ display: "block", background: T.surface, borderRadius: 8, border: `1px solid ${T.border}` }}>
            ...
            {losses.map((m, i) => (
              <g key={i}>
                <circle cx={sx(m.en)} cy={sy(m.bg)} r={6}
                  fill={m.isSV ? "#347d8b44" : "#50a1b144"}
                  stroke={m.isSV ? "#347d8b" : "#50a1b1"} strokeWidth={2} />
            ...
            {/* Legend */}
            <circle cx={350} cy={25} r={4} fill="#50a1b144" stroke="#50a1b1" strokeWidth={1.5} />
            <text x={358} y={28} fontSize={11} fill={T.muted}>Inside tube</text>
            <circle cx={350} cy={40} r={4} fill="#347d8b44" stroke="#347d8b" strokeWidth={1.5} />
      ...
      <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
        <div style={{ flex: "0 0 510px" }}>
          <svg width={svgW} height={svgH} style={{ display: "block", background: T.surface, borderRadius: 8, border: `1px solid ${T.border}` }}>
            ...
            {/* Input nodes */}
            <circle cx={60} cy={60} r={18} fill="#398a9a15" stroke="#398a9a" strokeWidth={1.5} />
            <text x={60} y={58} textAnchor="middle" fontSize={12} fill="#398a9a" fontWeight={500}>x₁</text>
            <text x={60} y={70} textAnchor="middle" fontSize={11} fill={T.muted}>{x1.toFixed(1)}</text>

            <circle cx={60} cy={140} r={18} fill="#398a9a15" stroke="#398a9a" strokeWidth={1.5} />
            <text x={60} y={138} textAnchor="middle" fontSize={12} fill="#398a9a" fontWeight={500}>x₂</text>
            ...
            <circle cx={280} cy={100} r={20} fill={output > 0.5 ? "#50a1b120" : "#347d8b20"}
              stroke={output > 0.5 ? "#50a1b1" : "#347d8b"} strokeWidth={2} />
            <text x={280} y={97} textAnchor="middle" fontSize={11} fill={output > 0.5 ? "#50a1b1" : "#347d8b"} fontWeight={500}>
              {output.toFixed(3)}
            </text>
        ...
        <div style={{ flex: 1, minWidth: 200 }}>
          ...
          <SliderRow label="x₁" value={x1} min={-2} max={2} step={0.1} onChange={setX1} color="#398a9a" />
          <SliderRow label="x₂" value={x2} min={-2} max={2} step={0.1} onChange={setX2} color="#398a9a" />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginTop: 10 }}>
            ...
            <ResultBox label="Output" value={output.toFixed(4)} color={output > 0.5 ? "#50a1b1" : "#347d8b"} />
          </div>
      ...
      <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
        <div style={{ flex: "0 0 510px" }}>
          <svg width={svgW} height={svgH} style={{ display: "block", background: T.surface, borderRadius: 8, border: `1px solid ${T.border}` }}>
            ...
            {/* Input layer */}
            <circle cx={50} cy={65} r={16} fill="#398a9a15" stroke="#398a9a" strokeWidth={1.5} />
            <text x={50} y={62} textAnchor="middle" fontSize={12} fill="#398a9a" fontWeight={500}>x₁</text>
            <text x={50} y={73} textAnchor="middle" fontSize={12} fill={T.muted}>{x1.toFixed(1)}</text>
            <circle cx={50} cy={140} r={16} fill="#398a9a15" stroke="#398a9a" strokeWidth={1.5} />
            <text x={50} y={137} textAnchor="middle" fontSize={12} fill="#398a9a" fontWeight={500}>x₂</text>
            ...
            {/* Output layer */}
            <circle cx={262} cy={100} r={18} fill={output > 0.5 ? "#50a1b120" : "#347d8b20"}
              stroke={output > 0.5 ? "#50a1b1" : "#347d8b"} strokeWidth={2} />
            <text x={262} y={97} textAnchor="middle" fontSize={12} fill={output > 0.5 ? "#50a1b1" : "#347d8b"} fontWeight={500}>
              {output.toFixed(3)}
            </text>
        ...
        <div style={{ flex: 1, minWidth: 200 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginTop: 10 }}>
            ...
            <ResultBox label="Output" value={output.toFixed(3)} color={output > 0.5 ? "#50a1b1" : "#347d8b"} />
          </div>
      ...
      <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
        ...
        <div style={{ flex: 1, minWidth: 200 }}>
          ...
          <div style={{ marginTop: 4, background: T.surface, borderRadius: 8, padding: 12, border: `1px solid ${T.border}` }}>
            ...
            <CalcRow eq={`Loss = (${yTrue} − ${cur.yhat.toFixed(4)})²`} result={cur.loss.toFixed(5)} color="#347d8b" />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginTop: 10 }}>
            <ResultBox label="Loss" value={cur.loss.toFixed(5)} color="#347d8b" sub={`step ${step}`} />
        ...
        <div style={{ flex: "0 0 510px" }}>
          <svg width={svgW} height={svgH} style={{ display: "block", background: T.surface, borderRadius: 8, border: `1px solid ${T.border}` }}>
            ...
            {inputPatch.map((row, i) => row.map((v, j) => (
              <g key={`i${i}${j}`}>
                <rect x={30 + j * 28} y={40 + i * 28} width={26} height={26} rx={3} fill="#398a9a11" stroke="#398a9a44" />
                <text x={43 + j * 28} y={57 + i * 28} textAnchor="middle" fontSize={11} fill="#398a9a" fontWeight={500}>{v}</text>
              </g>
            )))}
            {/* Multiply sign */}
...
function TransformerSection() {
  ...
  return (
    ...
    <Card color={C} title="Self-Attention — Full Numerical Example" formula="Attention(Q,K,V) = softmax(QK^T/√d_k)V">
      <div style={{ background: "#fafbfb", border: "1.5px solid #98bec533", borderRadius: 10, padding: "12px 16px", marginBottom: 14 }}>
        <div style={{ fontSize: 13, fontWeight: 500, color: "#317583", marginBottom: 4 }}>Setup: Three Atoms in FeO</div>
        <div style={{ fontSize: 13, lineHeight: 2.0, color: T.ink }}>
...
function AutoencoderSection() {
  ...
  return (
      ...
      <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
        <div style={{ flex: "0 0 510px" }}>
          <svg width={svgW} height={svgH} style={{ display: "block", background: T.surface, borderRadius: 8, border: `1px solid ${T.border}` }}>
            ...
            {/* Current point */}
            <circle cx={sx(latentX)} cy={sy(latentY)} r={7} fill="#347d8b44" stroke="#347d8b" strokeWidth={2} />
            <text x={sx(latentX)} y={sy(latentY) - 10} textAnchor="middle" fontSize={11} fill="#347d8b" fontWeight={500}>
              ? ({decodedBG.toFixed(2)} eV)
            </text>
            {/* Line to nearest */}
            <line x1={sx(latentX)} y1={sy(latentY)} x2={sx(nearest.lx)} y2={sy(nearest.ly)}
              stroke="#347d8b44" strokeWidth={1} strokeDasharray="3,3" />
          </svg>
        ...
        <div style={{ flex: 1, minWidth: 200 }}>
          ...
          <SliderRow label="Latent z₂" value={latentY} min={-2} max={2} step={0.1} onChange={setLatentY} color="#347d8b" />
    ...
    <Card color={C} title="Variational Autoencoder Loss — ELBO" formula="L = Reconstruction + KL Divergence">
      <div style={{ background: "#fafbfb", border: "1.5px solid #98bec533", borderRadius: 10, padding: "12px 16px", marginBottom: 14 }}>
        <div style={{ fontSize: 13, fontWeight: 500, color: "#317583", marginBottom: 4 }}>The ELBO (Evidence Lower Bound)</div>
        <div style={{ fontSize: 13, lineHeight: 2.0, color: T.ink }}>
      ...
      <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
        ...
        <div style={{ flex: 1, minWidth: 200 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginTop: 10 }}>
            ...
            <ResultBox label="Total ELBO" value={elboLoss.toFixed(4)} color="#347d8b" sub="minimize" />
          </div>
  ...
  return (
    ...
    <Card color={C} title="Generative Adversarial Networks & Model Comparison" formula="VAE vs GAN vs Diffusion">
      <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
        <div style={{ flex: "0 0 510px" }}>
          <div style={{ background: "#fafbfb", border: "1.5px solid #98bec533", borderRadius: 10, padding: "12px 16px", marginBottom: 14 }}>
            <div style={{ fontSize: 13, fontWeight: 500, color: "#317583", marginBottom: 4 }}>Generative Adversarial Networks (GANs)</div>
            <div style={{ fontSize: 13, lineHeight: 2.0, color: T.ink }}>
        ...
        <div style={{ flex: 1, minWidth: 200 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginTop: 10 }}>
            ...
            <ResultBox label="Diffusion" value="Diverse" color="#347d8b" sub="sample variety" />
          </div>
...
function ActiveLearningSection() {
  ...
  return (
    <Card color={C} title="Active Learning" formula="Next = argmax acquisition(x)">
      <div style={{ background: "#fafbfb", border: "1.5px solid #98bec533", borderRadius: 10, padding: "12px 16px", marginBottom: 14 }}>
        <div style={{ fontSize: 13, fontWeight: 500, color: "#317583", marginBottom: 4 }}>Simple Analogy — Bayesian Optimization for Alloy Design</div>
        <div style={{ fontSize: 13, lineHeight: 2.0, color: T.ink }}>
      ...
      <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
        <div style={{ flex: "0 0 510px" }}>
          <svg width={svgW} height={svgH} style={{ display: "block", background: T.surface, borderRadius: 8, border: `1px solid ${T.border}` }}>
            ...
            <circle cx={sx(bestCandidate.x)} cy={sy(predict(bestCandidate.x))} r={6}
              fill="#347d8b44" stroke="#347d8b" strokeWidth={2} />
            <text x={sx(bestCandidate.x)} y={sy(predict(bestCandidate.x)) - 10}
              textAnchor="middle" fontSize={11} fill="#347d8b" fontWeight={500}>Next? ({bestCandidate.x}% Cu)</text>
            {/* Axis ticks */}
        ...
        <div style={{ flex: 1, minWidth: 200 }}>
          <div style={{ marginTop: 0, background: T.surface, borderRadius: 8, padding: 12, border: `1px solid ${T.border}` }}>
            ...
            <CalcRow eq={`Suggested next: ${bestCandidate.x}% Cu`} result={`unc = ${gpUnc.toFixed(1)}`} color="#347d8b" />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginTop: 10 }}>
            ...
            <ResultBox label="Next test" value={`${bestCandidate.x}% Cu`} color="#347d8b" sub="highest uncertainty" />
          </div>
      ...
      <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
        ...
        <div style={{ flex: 1, minWidth: 200 }}>
          ...
          <div style={{ marginTop: 4, background: T.surface, borderRadius: 8, padding: 12, border: `1px solid ${T.border}` }}>
            ...
            <CalcRow eq={`Current vs Best`} result={`${((currentError - minError) / minError * 100).toFixed(1)}% worse`} color="#347d8b" />
          </div>
                ...
                return (
                  <g key={i}>
                    <rect x={centerX + (running - f.shap - m.base) * barScale / 2} y={y}
                      ...
                      fill={isPos ? "#347d8b33" : "#50a1b133"} stroke={isPos ? "#347d8b" : "#50a1b1"} strokeWidth={1} />
                    <text x={25} y={y + 12} fontSize={11} fill={T.muted}>{f.name}</text>
                    <text x={svgW - 10} y={y + 12} textAnchor="end" fontSize={11}
                      fill={isPos ? "#347d8b" : "#50a1b1"} fontWeight={500}>
          ...
          <div style={{ background: T.surface, borderRadius: 8, border: `1px solid ${T.border}`, overflow: "hidden" }}>
            ...
            {methods.map((m, i) => (
              <div key={i} style={{
                ...
                <span style={{ color: m.interp === "High" ? "#50a1b1" : m.interp === "Medium" ? M.accent : "#347d8b" }}>{m.interp}</span>
